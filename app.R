        ...
        fluidRow(
          ...
          userBox(
            title = userDescription(
              ...
              subtitle = "Bachelor of computer science in data science .",
              type = 2,
              image = "https://via.placeholder.com/150" # Replace with an actual image URL
            ),
            status = "success",
            "In my second year of a Computer Science bachelor's program, I work as a full-stack developer, data scientist and AI engineer."
          )
        ),
